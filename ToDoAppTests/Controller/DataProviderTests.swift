...
class DataProviderTests: XCTestCase {
    ...
    override func setUp() {
        ...
        controller = storyboard.instantiateViewController(
            withIdentifier: String(describing: TaskListViewController.self)) as? TaskListViewController
    ...
    func testNumberOfRowsInSectionZeroIsEqualTasksCount() {
    ...
    func testNumberOfRowsInSectionOneIsEqualDoneTasksCount() {
        sut.taskManager?.add(task: Task(title: "Foo"))
...
extension DataProviderTests {
    ...
    class MockTableView: UITableView {
        ...
        static func mockTableView(withDataSource dataSource: UITableViewDataSource) -> MockTableView {
            let mockTableView = MockTableView(frame: CGRect(x: 0,
                                                            y: 0,
                                                            width: 375,
                                                            height: 658),
                                              style: .plain)
            mockTableView.dataSource = dataSource
            mockTableView.register(MockTaskCell.self,
